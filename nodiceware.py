...
class NoDiceware:
  ...
  def __init__(self, roll, special):
    self.passphrase = []
  ...
  def make_passphrase(self):
    ...
    if(not rolls.isnumeric() or ('0' in rolls or '7' in rolls or '8' in rolls or '9' in rolls)):
  ...
  def get_word(self, roll):
    ...
    self.passphrase.append(self.wordlist[roll]);
  ...
  def add_special_character(self,roll):
    ...
    if(int(roll[0]) > len(self.passphrase)):
